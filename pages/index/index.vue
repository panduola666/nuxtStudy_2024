      ...
      <main class="overflow-hidden">
        ...
        >
          ...
          >
            ...
            >
              <SwiperSlide
                v-for="(img, imgIndex) in bestRoom.imageUrlList"
                :key="imgIndex"
              >
                <picture>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <span
                          class="fw-bold"
                          v-for="(str, strIndex) in item.diningTime.split(' ')"
                          :key="strIndex"
                          >{{ str }}</span
                        >
                      </div>
...
const culinaryStore = useCulinaryStore();
const { culinaryList } = storeToRefs(culinaryStore);
...
const bestRoom = computed(() => {
  const activeRooms = roomsList.value
